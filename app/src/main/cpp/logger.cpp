...
Java_com_joyrun_logger_Logger_initNative(JNIEnv *env, jobject thiz, jstring buffer_path_,
...
Java_com_joyrun_logger_Logger_write(JNIEnv *env, jobject thiz, jlong ptr, jstring log_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_joyrun_logger_Logger_flushAsync(JNIEnv *env, jobject thiz, jlong ptr) {
    LogBuffer *logBuffer = reinterpret_cast<LogBuffer *>(ptr);
    logBuffer->async_flush(fileFlush);
}
extern "C"
JNIEXPORT void JNICALL
Java_com_joyrun_logger_Logger_release(JNIEnv *env, jobject thiz, jlong ptr) {
    LogBuffer *logBuffer = reinterpret_cast<LogBuffer *>(ptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_joyrun_logger_Logger_changeLogPath(JNIEnv *env, jobject thiz, jlong ptr,
                                            jstring logFilePath) {
...
Java_com_joyrun_logger_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
